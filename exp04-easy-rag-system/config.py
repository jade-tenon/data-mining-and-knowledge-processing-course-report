...
PREVIEW_MAX_LENGTH = 350
# Model Configuration
# Example: 'all-MiniLM-L6-v2' (dim 384), 'thenlper/gte-large' (dim 1024)
EMBEDDING_MODEL_NAME = 'all-MiniLM-L6-v2'
GENERATION_MODEL_NAME = "D:\Work\interpreters\Project\Pycharm\datamining\exp02-sentiment-classificationn\qwen-sentential-classifier\Qwen\Qwen2505"
